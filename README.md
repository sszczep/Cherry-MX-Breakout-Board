...
> Kailh Socket 3D Model was obtained from [*QMK*](https://github.com/qmk). All the credits go to them. Exact file can be found [here](https://github.com/qmk/qmk_hardware/blob/master/components/kailh_socket_mx.stp).
